      ...
      <div className="mx-auto max-w-[1280px] px-8">
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-12">
          <div>
            ...
            <p className="mt-[18px] text-[14.5px] leading-[1.55] max-w-[360px]">
              Local Kansas City cash buyers and investors. We close on distressed off-market deals from agents in 7 to 14 days.
            </p>
